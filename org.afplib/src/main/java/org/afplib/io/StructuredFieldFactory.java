...
class StructuredFieldFactory extends AbstractStructuredFieldFactory {
	...
	int sstop = pos+16;		
			...
			if(stop >= pos+16) {
					...
					obj.setBCdoName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
			...
			if(stop >= pos+16) {
					...
					obj.setIndxName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
				...
				if(sstop <= stop)
					...
					obj.setOvlyName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
				...
				if(sstop <= stop)
					...
					obj.setPGrpName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
				...
				if(sstop <= stop)
					...
					obj.setObjCName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
			...
			if(stop >= pos+16) {
					...
					obj.setPageName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
				...
				if(sstop <= stop)
					...
					obj.setPsegName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
			...
			if(stop >= pos+16) {
					...
					obj.setPTdoName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
			...
			if(stop >= pos+16) {
					...
					obj.setRGrpName(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+16;		
				...
				if(sstop <= stop)
					...
					obj.setDefCharID(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	int sstop = pos+40;		
				...
				if(sstop <= stop)
					...
					obj.setTypeFcDesc(new String(buffer, pos+9, sstop-pos-9+1, CodepageHelper.CHARSET_IBM500));
	...
	obj.setIBMFormat(Data.toUnsigned(buffer, pos+9, sstop));
	...
	obj.setTechnologyFormat(Data.toUnsigned(buffer, pos+10, sstop));
		...
		case 13889275: {
			IPD obj = AfplibFactory.eINSTANCE.createIPD();
				...
				if(missingImageData > 0) {
					int imlength = Math.min(stop + 1 - (pos + 9), missingImageData);
					obj.setImageData(Arrays.copyOfRange(buffer, pos + 9, pos + 9 + imlength));
	...
	int sstop = pos+34;		
				...
				if(sstop <= stop)
					...
					obj.setSupName(new String(buffer, pos+27, sstop-pos-27+1, CodepageHelper.CHARSET_IBM500));
	...
	obj.setDSID(Arrays.copyOfRange(buffer, pos+17, sstop + 1));
			...
			case 39: {
				LineDataObjectPositionMigration obj = AfplibFactory.eINSTANCE.createLineDataObjectPositionMigration();
	...
	obj.setTempOrient(Data.toUnsigned(buffer, pos+2, sstop));
			...
			case 145: {
				ColorManagementResourceDescriptor obj = AfplibFactory.eINSTANCE.createColorManagementResourceDescriptor();
	...
	obj.setYResol(Data.toUnsigned(buffer, pos+8, sstop));
			...
			case 156: {
				ObjectContainerPresentationSpaceSize obj = AfplibFactory.eINSTANCE.createObjectContainerPresentationSpaceSize();
	...
	obj.setPDFSize(Data.toUnsigned(buffer, pos+4, sstop));
			...
			case 34: {
				ExtendedResourceLocalIdentifier obj = AfplibFactory.eINSTANCE.createExtendedResourceLocalIdentifier();
	...
	obj.setReserved2(Data.toUnsigned(buffer, pos+8, sstop));
			...
			case 32: {
				FontCodedGraphicCharacterSetGlobalIdentifier obj = AfplibFactory.eINSTANCE.createFontCodedGraphicCharacterSetGlobalIdentifier();
	...
	obj.setObOrent(Data.toUnsigned(buffer, pos+17, sstop));
			...
			case 70: {
				PageOverlayConditionalProcessing obj = AfplibFactory.eINSTANCE.createPageOverlayConditionalProcessing();
	...
	int _CFIRG(CFIRG obj, byte[] buffer, int start) {
		...
		if(obj.getReserved() != null) {
			...
			if(20 + size > length) length = 20 + size;
			}
	...
	int _LLERG(LLERG obj, byte[] buffer, int start) {
		int length = 0;
			...
			if(3 + size > length) length = 3 + size;
	...
	int _MCFRG(MCFRG obj, byte[] buffer, int start) {
		int length = 0;
			...
			if(2 + size > length) length = 2 + size;
	...
	int _PPORG(PPORG obj, byte[] buffer, int start) {
		int length = 0;
			...
			if(12 + size > length) length = 12 + size;
	...
	int _FNNRG2(FNNRG2 obj, byte[] buffer, int start) {
		...
		if(obj.getTSID() != null) {
			...
			if(1 + size > length) length = 1 + size;
			}
	...
	int binary_triplets(byte[] buffer, int bstart, List<Triplet> triplets) {
		...
		if(obj.getAttVal() != null) {
			...
			if(4 + size > length) length = 4 + size;
			}
		...
		if(obj.getVarCde() != null) {
			...
			if(36 + size > length) length = 36 + size;
			}
		...
		if(obj.getOpPos() != null) {
			...
			if(9 + size > length) length = 9 + size;
			}
	...
	int binary_sdf(byte[] buffer, int bstart, List<Triplet> triplets) {
		...
		if(obj.getDATA() != null) {
			...
			if(7 + size > length) length = 7 + size;
			}
		...
		if(obj.getRg() != null && obj.getRg().size() > 0) {
			...
			if(6 + size > length) length = 6 + size;
	...
	int binary_cs(byte[] buffer, int bstart, List<Triplet> triplets) {
		...
		if(obj.getCOLVALUE() != null) {
			...
			if(11 + size > length) length = 11 + size;
			}
	...
	public int binary(byte[] buffer, int start, SF sf) {
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(17 + size > length) length = 17 + size;
		...
		if(obj.getData() != null) {
			...
			if(14 + size > length) length = 14 + size;
			}
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(32 + size > length) length = 32 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(18 + size > length) length = 18 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(19 + size > length) length = 19 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(21 + size > length) length = 21 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(51 + size > length) length = 51 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(89 + size > length) length = 89 + size;
		...
		if(obj.getIBMFormat() != null) {
			...
			Saver.saveUnsigned(buffer, start + 9, start + 9, obj.getIBMFormat());
		...
		if(obj.getTechnologyFormat() != null) {
			...
			Saver.saveUnsigned(buffer, start + 10, start + 10, obj.getTechnologyFormat());
		...
		case AfplibPackage.IPG: {
			...
			if(26 + size > length) length = 26 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(25 + size > length) length = 25 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(23 + size > length) length = 23 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(49 + size > length) length = 49 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(22 + size > length) length = 22 + size;
		...
		if(obj.getTriplets() != null && obj.getTriplets().size() > 0) {
			...
			if(24 + size > length) length = 24 + size;
		...
		case AfplibPackage.PGP: {
			...
			if(10 + size > length) length = 10 + size;
