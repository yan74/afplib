...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>FNC Xfr Units</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getFNCXfrUnits()
 * @model
 * @generated
 */
public enum FNCXfrUnits implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>FNC Xfr Units</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FNCXfrUnits[] VALUES_ARRAY =
		new FNCXfrUnits[] {
	...
	/**
	 * A public read-only list of all the '<em><b>FNC Xfr Units</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FNCXfrUnits> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>FNC Xfr Units</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FNCXfrUnits get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FNCXfrUnits result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FNC Xfr Units</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FNCXfrUnits getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FNCXfrUnits result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FNC Xfr Units</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FNCXfrUnits get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FNCXfrUnits(int value, String name, String literal) {
		this.value = value;
		this.name = name;
