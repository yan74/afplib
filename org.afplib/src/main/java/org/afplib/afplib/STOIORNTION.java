...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>STOIORNTION</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getSTOIORNTION()
 * @model
 * @generated
 */
public enum STOIORNTION implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>STOIORNTION</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final STOIORNTION[] VALUES_ARRAY =
		new STOIORNTION[] {
			CONST0DEGREES,
			CONST90DEGREES,
			CONST180DEGREES,
	...
	/**
	 * A public read-only list of all the '<em><b>STOIORNTION</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<STOIORNTION> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>STOIORNTION</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static STOIORNTION get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			STOIORNTION result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>STOIORNTION</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static STOIORNTION getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			STOIORNTION result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>STOIORNTION</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static STOIORNTION get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private STOIORNTION(int value, String name, String literal) {
		this.value = value;
		this.name = name;
