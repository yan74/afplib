...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rendering Intent Reserved</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getRenderingIntentReserved()
 * @model
 * @generated
 */
public enum RenderingIntentReserved implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Rendering Intent Reserved</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RenderingIntentReserved[] VALUES_ARRAY =
		new RenderingIntentReserved[] {
			CONST_ZERO,
		};

	/**
	 * A public read-only list of all the '<em><b>Rendering Intent Reserved</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RenderingIntentReserved> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static RenderingIntentReserved get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RenderingIntentReserved result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	private RenderingIntentReserved(int value, String name, String literal) {
		this.value = value;
		this.name = name;
