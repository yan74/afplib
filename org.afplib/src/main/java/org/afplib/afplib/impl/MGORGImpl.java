...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MGORG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MGORGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MGORGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MGORGImpl extends TripletImpl implements MGORG {
	/**
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MGORG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MGORG__TRIPLETS);
		}
		return triplets;
	}
