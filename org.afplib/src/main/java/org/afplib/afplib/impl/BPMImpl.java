...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BPM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.BPMImpl#getPMName <em>PM Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BPMImpl extends SFImpl implements BPM {
	/**
	...
	public void setPMName(String newPMName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.BPM__PM_NAME, oldPMName, pmName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.BPM__PM_NAME:
				return getPMName();
		}
