 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.BFGImpl#getFEGName <em>FEG Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BFGImpl extends SFImpl implements BFG {
	/**
	...
	public void setFEGName(String newFEGName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.BFG__FEG_NAME, oldFEGName, fegName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.BFG__FEG_NAME:
				return getFEGName();
		}
