...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>FGD</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.FGDImpl#getConData <em>Con Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FGDImpl extends SFImpl implements FGD {
	/**
	...
	public void setConData(byte[] newConData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.FGD__CON_DATA, oldConData, conData));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.FGD__CON_DATA:
				return getConData();
		}
