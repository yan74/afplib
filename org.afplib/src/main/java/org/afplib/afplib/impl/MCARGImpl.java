...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MCARG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MCARGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MCARGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MCARGImpl extends TripletImpl implements MCARG {
	/**
	...
	protected EClass eStaticClass() {
        return AfplibPackage.eINSTANCE.getMCARG();
    }
	...
	public void setRGLength(Integer newRGLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MCARG__RG_LENGTH, oldRGLength, rgLength));
    }
	...
	public EList<Triplet> getTriplets() {
        if (triplets == null) {
            triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MCARG__TRIPLETS);
        }
        return triplets;
    }
