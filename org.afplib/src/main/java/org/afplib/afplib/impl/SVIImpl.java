 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.SVIImpl#getINCRMENT <em>INCRMENT</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SVIImpl extends TripletImpl implements SVI {
	...
	public void setINCRMENT(Integer newINCRMENT) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.SVI__INCRMENT, oldINCRMENT, incrment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.SVI__INCRMENT:
				return getINCRMENT();
		}
