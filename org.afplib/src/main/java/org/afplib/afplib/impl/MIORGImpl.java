...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MIORG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MIORGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MIORGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MIORGImpl extends TripletImpl implements MIORG {
	/**
	...
	public void setRGLength(Integer newRGLength) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MIORG__RG_LENGTH, oldRGLength, rgLength));
    }
	...
	public EList<Triplet> getTriplets() {
        if (triplets == null) {
            triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MIORG__TRIPLETS);
        }
        return triplets;
    }
