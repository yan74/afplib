...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MPORG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class MPORGImpl extends TripletImpl implements MPORG {
	/**
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MPORG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MPORG__TRIPLETS);
		}
		return triplets;
	}
