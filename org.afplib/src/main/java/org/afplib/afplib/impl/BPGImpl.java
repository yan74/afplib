...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BPG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.BPGImpl#getPageName <em>Page Name</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.BPGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BPGImpl extends SFImpl implements BPG {
	/**
	...
	protected EClass eStaticClass() {
		return AfplibPackage.eINSTANCE.getBPG();
	}
	...
	public void setPageName(String newPageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.BPG__PAGE_NAME, oldPageName, pageName));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.BPG__TRIPLETS);
		}
		return triplets;
	}
