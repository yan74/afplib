 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MCDRGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MCDRGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MCDRGImpl extends TripletImpl implements MCDRG {
	/**
	...
	protected EClass eStaticClass() {
		return AfplibPackage.eINSTANCE.getMCDRG();
	}
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MCDRG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MCDRG__TRIPLETS);
		}
		return triplets;
	}
