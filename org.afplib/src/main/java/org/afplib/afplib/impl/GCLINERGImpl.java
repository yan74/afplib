 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.GCLINERGImpl#getXPOS <em>XPOS</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.GCLINERGImpl#getYPOS <em>YPOS</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GCLINERGImpl extends TripletImpl implements GCLINERG {
	/**
	...
	protected EClass eStaticClass() {
        return AfplibPackage.eINSTANCE.getGCLINERG();
    }
	...
	public void setXPOS(Integer newXPOS) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GCLINERG__XPOS, oldXPOS, xpos));
    }
	...
	public void setYPOS(Integer newYPOS) {
        ...
        ypos = newYPOS;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GCLINERG__YPOS, oldYPOS, ypos));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case AfplibPackage.GCLINERG__XPOS:
                return getXPOS();
            case AfplibPackage.GCLINERG__YPOS:
                return getYPOS();
        }
