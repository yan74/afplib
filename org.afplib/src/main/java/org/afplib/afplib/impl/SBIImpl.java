...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>SBI</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.SBIImpl#getINCRMENT <em>INCRMENT</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SBIImpl extends TripletImpl implements SBI {
	/**
	...
	public void setINCRMENT(Integer newINCRMENT) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.SBI__INCRMENT, oldINCRMENT, incrment));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case AfplibPackage.SBI__INCRMENT:
                return getINCRMENT();
        }
