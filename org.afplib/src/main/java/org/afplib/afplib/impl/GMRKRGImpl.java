...
import org.afplib.afplib.GMRKRG;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GMRKRG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.GMRKRGImpl#getXPOS <em>XPOS</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.GMRKRGImpl#getYPOS <em>YPOS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GMRKRGImpl extends TripletImpl implements GMRKRG {
	/**
	...
	protected EClass eStaticClass() {
		return AfplibPackage.eINSTANCE.getGMRKRG();
	}
	...
	public void setXPOS(Integer newXPOS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GMRKRG__XPOS, oldXPOS, xpos));
	}
	...
	public void setYPOS(Integer newYPOS) {
		...
		ypos = newYPOS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GMRKRG__YPOS, oldYPOS, ypos));
	}
