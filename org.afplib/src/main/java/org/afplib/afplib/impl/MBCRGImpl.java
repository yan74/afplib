...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MBCRG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MBCRGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MBCRGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBCRGImpl extends TripletImpl implements MBCRG {
	/**
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MBCRG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MBCRG__TRIPLETS);
		}
		return triplets;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AfplibPackage.MBCRG__TRIPLETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.MBCRG__RG_LENGTH:
				return getRGLength();
			case AfplibPackage.MBCRG__TRIPLETS:
				return getTriplets();
		}
