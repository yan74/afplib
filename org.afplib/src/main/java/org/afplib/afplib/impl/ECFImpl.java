 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.ECFImpl#getRSName <em>RS Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ECFImpl extends SFImpl implements ECF {
	...
	public void setRSName(String newRSName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.ECF__RS_NAME, oldRSName, rsName));
    }
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case AfplibPackage.ECF__RS_NAME:
                return getRSName();
        }
