 ...
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.GSCAImpl#getXPOS <em>XPOS</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.GSCAImpl#getYPOS <em>YPOS</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GSCAImpl extends TripletImpl implements GSCA {
	...
	public void setXPOS(Integer newXPOS) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GSCA__XPOS, oldXPOS, xpos));
	}
	...
	public void setYPOS(Integer newYPOS) {
		...
		ypos = newYPOS;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.GSCA__YPOS, oldYPOS, ypos));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.GSCA__XPOS:
				return getXPOS();
			case AfplibPackage.GSCA__YPOS:
				return getYPOS();
		}
