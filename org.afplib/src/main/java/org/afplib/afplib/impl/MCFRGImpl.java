...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MCFRG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class MCFRGImpl extends TripletImpl implements MCFRG {
	/**
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MCFRG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MCFRG__TRIPLETS);
		}
		return triplets;
	}
