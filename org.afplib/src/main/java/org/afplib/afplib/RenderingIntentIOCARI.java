...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rendering Intent IOCARI</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getRenderingIntentIOCARI()
 * @model
 * @generated
 */
public enum RenderingIntentIOCARI implements Enumerator {
	/**
	...
	/**
     * An array of all the '<em><b>Rendering Intent IOCARI</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	private static final RenderingIntentIOCARI[] VALUES_ARRAY =
		new RenderingIntentIOCARI[] {
            CONST_PERCEPTUAL,
	...
	/**
     * A public read-only list of all the '<em><b>Rendering Intent IOCARI</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	public static final List<RenderingIntentIOCARI> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
     * Returns the '<em><b>Rendering Intent IOCARI</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @generated
     */
	public static RenderingIntentIOCARI get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            RenderingIntentIOCARI result = VALUES_ARRAY[i];
	...
	/**
     * Returns the '<em><b>Rendering Intent IOCARI</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
	public static RenderingIntentIOCARI getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            RenderingIntentIOCARI result = VALUES_ARRAY[i];
	...
	/**
     * Returns the '<em><b>Rendering Intent IOCARI</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @generated
     */
	public static RenderingIntentIOCARI get(int value) {
        switch (value) {
     ...
     * @generated
     */
	private RenderingIntentIOCARI(int value, String name, String literal) {
        this.value = value;
        this.name = name;
