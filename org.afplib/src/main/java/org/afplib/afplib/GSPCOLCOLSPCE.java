...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>GSPCOLCOLSPCE</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getGSPCOLCOLSPCE()
 * @model
 * @generated
 */
public enum GSPCOLCOLSPCE implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>GSPCOLCOLSPCE</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final GSPCOLCOLSPCE[] VALUES_ARRAY =
		new GSPCOLCOLSPCE[] {
			CONST_RGB,
			CONST_CMYK,
			CONST_HIGHLIGHT,
	...
	/**
	 * A public read-only list of all the '<em><b>GSPCOLCOLSPCE</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<GSPCOLCOLSPCE> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>GSPCOLCOLSPCE</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static GSPCOLCOLSPCE get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GSPCOLCOLSPCE result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>GSPCOLCOLSPCE</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static GSPCOLCOLSPCE getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			GSPCOLCOLSPCE result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>GSPCOLCOLSPCE</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static GSPCOLCOLSPCE get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private GSPCOLCOLSPCE(int value, String name, String literal) {
		this.value = value;
		this.name = name;
