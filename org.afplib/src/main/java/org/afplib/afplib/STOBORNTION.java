...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>STOBORNTION</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getSTOBORNTION()
 * @model
 * @generated
 */
public enum STOBORNTION implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>STOBORNTION</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final STOBORNTION[] VALUES_ARRAY =
		new STOBORNTION[] {
			CONST0DEGREES,
			CONST90DEGREES,
			CONST180DEGREES,
	...
	/**
	 * A public read-only list of all the '<em><b>STOBORNTION</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<STOBORNTION> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>STOBORNTION</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static STOBORNTION get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			STOBORNTION result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>STOBORNTION</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static STOBORNTION getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			STOBORNTION result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>STOBORNTION</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static STOBORNTION get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private STOBORNTION(int value, String name, String literal) {
		this.value = value;
		this.name = name;
