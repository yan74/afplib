...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rendering Intent OCRI</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getRenderingIntentOCRI()
 * @model
 * @generated
 */
public enum RenderingIntentOCRI implements Enumerator {
	/**
	...
	/**
     * An array of all the '<em><b>Rendering Intent OCRI</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	private static final RenderingIntentOCRI[] VALUES_ARRAY =
		new RenderingIntentOCRI[] {
            CONST_PERCEPTUAL,
	...
	/**
     * A public read-only list of all the '<em><b>Rendering Intent OCRI</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	public static final List<RenderingIntentOCRI> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	...
	public static RenderingIntentOCRI get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            RenderingIntentOCRI result = VALUES_ARRAY[i];
     ...
     * @generated
     */
	private RenderingIntentOCRI(int value, String name, String literal) {
        this.value = value;
        this.name = name;
