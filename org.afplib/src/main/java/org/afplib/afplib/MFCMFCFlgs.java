...
public enum MFCMFCFlgs implements Enumerator {
	 ...
	 * @ordered
	 */
	ACTIVATE_MEDIUM_FINISH_CONTROL(128, "ActivateMediumFinishControl", "ActivateMediumFinishControl");
	 ...
	 * @ordered
	 */
	public static final int ACTIVATE_MEDIUM_FINISH_CONTROL_VALUE = 128;
