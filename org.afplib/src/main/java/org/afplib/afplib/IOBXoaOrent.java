...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>IOB Xoa Orent</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getIOBXoaOrent()
 * @model
 * @generated
 */
public enum IOBXoaOrent implements Enumerator {
	/**
	...
	/**
     * An array of all the '<em><b>IOB Xoa Orent</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	private static final IOBXoaOrent[] VALUES_ARRAY =
		new IOBXoaOrent[] {
            CONST0DEGREES,
            CONST90DEGREES,
            CONST180DEGREES,
	...
	/**
     * A public read-only list of all the '<em><b>IOB Xoa Orent</b></em>' enumerators.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
	public static final List<IOBXoaOrent> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
     * Returns the '<em><b>IOB Xoa Orent</b></em>' literal with the specified literal value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @generated
     */
	public static IOBXoaOrent get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IOBXoaOrent result = VALUES_ARRAY[i];
	...
	/**
     * Returns the '<em><b>IOB Xoa Orent</b></em>' literal with the specified name.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @param name the name.
     * @return the matching enumerator or <code>null</code>.
     * @generated
     */
	public static IOBXoaOrent getByName(String name) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            IOBXoaOrent result = VALUES_ARRAY[i];
	...
	/**
     * Returns the '<em><b>IOB Xoa Orent</b></em>' literal with the specified integer value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     ...
     * @generated
     */
	public static IOBXoaOrent get(int value) {
        switch (value) {
     ...
     * @generated
     */
	private IOBXoaOrent(int value, String name, String literal) {
        this.value = value;
        this.name = name;
