...
public enum CPCVSFlags implements Enumerator {
     ...
     * @ordered
     */
	SORT_ORDER(128, "SortOrder", "SortOrder"),
     ...
     * @ordered
     */
	VARIABLE_SPACE(8, "VariableSpace", "VariableSpace");
     ...
     * @ordered
     */
	public static final int SORT_ORDER_VALUE = 128;
     ...
     * @ordered
     */
	public static final int VARIABLE_SPACE_VALUE = 8;
