...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>IPO Ovly Orent</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getIPOOvlyOrent()
 * @model
 * @generated
 */
public enum IPOOvlyOrent implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>IPO Ovly Orent</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final IPOOvlyOrent[] VALUES_ARRAY =
		new IPOOvlyOrent[] {
			CONST0DEGREES,
			CONST90DEGREES,
			CONST180DEGREES,
	...
	/**
	 * A public read-only list of all the '<em><b>IPO Ovly Orent</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>IPO Ovly Orent</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IPOOvlyOrent get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IPOOvlyOrent result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>IPO Ovly Orent</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static IPOOvlyOrent getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IPOOvlyOrent result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>IPO Ovly Orent</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static IPOOvlyOrent get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private IPOOvlyOrent(int value, String name, String literal) {
		this.value = value;
		this.name = name;
