...
public enum CPCPrtFlags implements Enumerator {
     ...
     * @ordered
     */
	PRESENTATION(64, "Presentation", "Presentation"),
     ...
     * @ordered
     */
	INCREMENT(32, "Increment", "Increment");
     ...
     * @ordered
     */
	public static final int PRESENTATION_VALUE = 64;
     ...
     * @ordered
     */
	public static final int INCREMENT_VALUE = 32;
