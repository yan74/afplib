...
public enum FNDFtDsFlags implements Enumerator {
     ...
     * @ordered
     */
	UNDERSCORED(16384, "Underscored", "Underscored"),
     ...
     * @ordered
     */
	OVERSTRUCK(2048, "Overstruck", "Overstruck");
     ...
     * @ordered
     */
	public static final int ITALIC_VALUE = 32768;
     ...
     * @ordered
     */
	public static final int UNDERSCORED_VALUE = 16384;
     ...
     * @ordered
     */
	public static final int SOLID_VALUE = 4096;
     ...
     * @ordered
     */
	public static final int OVERSTRUCK_VALUE = 2048;
