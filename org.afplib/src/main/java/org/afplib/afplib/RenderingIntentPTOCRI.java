...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rendering Intent PTOCRI</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getRenderingIntentPTOCRI()
 * @model
 * @generated
 */
public enum RenderingIntentPTOCRI implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Rendering Intent PTOCRI</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RenderingIntentPTOCRI[] VALUES_ARRAY =
		new RenderingIntentPTOCRI[] {
			CONST_PERCEPTUAL,
	...
	/**
	 * A public read-only list of all the '<em><b>Rendering Intent PTOCRI</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RenderingIntentPTOCRI> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Rendering Intent PTOCRI</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RenderingIntentPTOCRI get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RenderingIntentPTOCRI result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rendering Intent PTOCRI</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RenderingIntentPTOCRI getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RenderingIntentPTOCRI result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rendering Intent PTOCRI</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RenderingIntentPTOCRI get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RenderingIntentPTOCRI(int value, String name, String literal) {
		this.value = value;
		this.name = name;
