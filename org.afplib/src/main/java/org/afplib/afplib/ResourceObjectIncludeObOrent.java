...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Resource Object Include Ob Orent</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getResourceObjectIncludeObOrent()
 * @model
 * @generated
 */
public enum ResourceObjectIncludeObOrent implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Resource Object Include Ob Orent</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ResourceObjectIncludeObOrent[] VALUES_ARRAY =
		new ResourceObjectIncludeObOrent[] {
			CONST0DEGREES,
			CONST90DEGREES,
			CONST180DEGREES,
			CONST270DEGREES,
	...
	/**
	 * A public read-only list of all the '<em><b>Resource Object Include Ob Orent</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ResourceObjectIncludeObOrent> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Resource Object Include Ob Orent</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ResourceObjectIncludeObOrent get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ResourceObjectIncludeObOrent result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Resource Object Include Ob Orent</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ResourceObjectIncludeObOrent getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ResourceObjectIncludeObOrent result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Resource Object Include Ob Orent</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ResourceObjectIncludeObOrent get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ResourceObjectIncludeObOrent(int value, String name, String literal) {
		this.value = value;
		this.name = name;
