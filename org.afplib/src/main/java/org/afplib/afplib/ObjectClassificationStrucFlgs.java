...
public enum ObjectClassificationStrucFlgs implements Enumerator {
	 ...
	 * @ordered
	 */
	OBJECT_CONTAINER(1, "ObjectContainer", "ObjectContainer"),
	 ...
	 * @ordered
	 */
	OBJECT_CONTAINER2(2, "ObjectContainer2", "ObjectContainer2"),
	 ...
	 * @ordered
	 */
	OBJECT_ENVIRONMENT_GROUP(4, "ObjectEnvironmentGroup", "ObjectEnvironmentGroup"),
	 ...
	 * @ordered
	 */
	OBJECT_ENVIRONMENT_GROUP2(8, "ObjectEnvironmentGroup2", "ObjectEnvironmentGroup2"),
	 ...
	 * @ordered
	 */
	OBJECT_CONTAINER_DATA(16, "ObjectContainerData", "ObjectContainerData"),
	 ...
	 * @ordered
	 */
	OBJECT_CONTAINER_DATA2(32, "ObjectContainerData2", "ObjectContainerData2");
	 ...
	 * @ordered
	 */
	public static final int OBJECT_CONTAINER_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int OBJECT_CONTAINER2_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int OBJECT_ENVIRONMENT_GROUP_VALUE = 4;
	 ...
	 * @ordered
	 */
	public static final int OBJECT_ENVIRONMENT_GROUP2_VALUE = 8;
	 ...
	 * @ordered
	 */
	public static final int OBJECT_CONTAINER_DATA_VALUE = 16;
	 ...
	 * @ordered
	 */
	public static final int OBJECT_CONTAINER_DATA2_VALUE = 32;
