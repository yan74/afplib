...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BFN</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.BFNImpl#getRSName <em>RS Name</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.BFNImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BFNImpl extends SFImpl implements BFN {
	/**
	...
	public void setRSName(String newRSName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.BFN__RS_NAME, oldRSName, rsName));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.BFN__TRIPLETS);
		}
		return triplets;
	}
