 ...
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.BCPImpl#getRSName <em>RS Name</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.BCPImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BCPImpl extends SFImpl implements BCP {
	/**
	...
	public void setRSName(String newRSName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.BCP__RS_NAME, oldRSName, rsName));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.BCP__TRIPLETS);
		}
		return triplets;
	}
