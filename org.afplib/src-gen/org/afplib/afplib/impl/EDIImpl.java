 ...
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.EDIImpl#getIndxName <em>Indx Name</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.EDIImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EDIImpl extends SFImpl implements EDI {
	/**
	...
	public void setIndxName(String newIndxName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.EDI__INDX_NAME, oldIndxName, indxName));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.EDI__TRIPLETS);
		}
		return triplets;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AfplibPackage.EDI__TRIPLETS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AfplibPackage.EDI__INDX_NAME:
				return getIndxName();
			case AfplibPackage.EDI__TRIPLETS:
				return getTriplets();
		}
