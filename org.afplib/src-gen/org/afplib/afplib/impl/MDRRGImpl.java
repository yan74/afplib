...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MDRRG</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.afplib.afplib.impl.MDRRGImpl#getRGLength <em>RG Length</em>}</li>
 *   <li>{@link org.afplib.afplib.impl.MDRRGImpl#getTriplets <em>Triplets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MDRRGImpl extends TripletImpl implements MDRRG {
	/**
	...
	protected EClass eStaticClass() {
		return AfplibPackage.eINSTANCE.getMDRRG();
	}
	...
	public void setRGLength(Integer newRGLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AfplibPackage.MDRRG__RG_LENGTH, oldRGLength, rgLength));
	}
	...
	public EList<Triplet> getTriplets() {
		if (triplets == null) {
			triplets = new EObjectContainmentEList.Resolving<Triplet>(Triplet.class, this, AfplibPackage.MDRRG__TRIPLETS);
		}
		return triplets;
	}
