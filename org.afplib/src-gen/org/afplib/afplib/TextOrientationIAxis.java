...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Text Orientation IAxis</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getTextOrientationIAxis()
 * @model
 * @generated
 */
public enum TextOrientationIAxis implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Text Orientation IAxis</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final TextOrientationIAxis[] VALUES_ARRAY =
		new TextOrientationIAxis[] {
			CONST0DEGREES,
			CONST90DEGREES,
			CONST180DEGREES,
			CONST270DEGREES,
	...
	/**
	 * A public read-only list of all the '<em><b>Text Orientation IAxis</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TextOrientationIAxis> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Text Orientation IAxis</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TextOrientationIAxis get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TextOrientationIAxis result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Text Orientation IAxis</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TextOrientationIAxis getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TextOrientationIAxis result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Text Orientation IAxis</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static TextOrientationIAxis get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TextOrientationIAxis(int value, String name, String literal) {
		this.value = value;
		this.name = name;
