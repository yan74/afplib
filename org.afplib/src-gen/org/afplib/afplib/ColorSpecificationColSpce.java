...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Color Specification Col Spce</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.afplib.afplib.AfplibPackage#getColorSpecificationColSpce()
 * @model
 * @generated
 */
public enum ColorSpecificationColSpce implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Color Specification Col Spce</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ColorSpecificationColSpce[] VALUES_ARRAY =
		new ColorSpecificationColSpce[] {
			CONST_RGB,
			CONST_CMYK,
			CONST_HIGHLIGHT,
			CONST_CIELAB,
	...
	/**
	 * A public read-only list of all the '<em><b>Color Specification Col Spce</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ColorSpecificationColSpce> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Color Specification Col Spce</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ColorSpecificationColSpce get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ColorSpecificationColSpce result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Color Specification Col Spce</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ColorSpecificationColSpce getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ColorSpecificationColSpce result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Color Specification Col Spce</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ColorSpecificationColSpce get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ColorSpecificationColSpce(int value, String name, String literal) {
		this.value = value;
		this.name = name;
